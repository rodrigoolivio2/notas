             ...
             if(isset ($nome)){
                ...
                */
                ...
                if($media>=7){
                    ...
                    echo "<p>";
                    echo "O aluno " . $nome . " está APROVADO com a media " . $media;
                    echo "</p>";

                }elseif($media>=5){

                    echo "<p>";
                    echo "O aluno " . $nome . " está RECUPERAÇÃO com a media " . $media;
                    echo "</p>"; 
                }else{
                    echo "<p>";
                    echo "O aluno " . $nome . " está REPROVADO com a media " . $media;
                    echo "</p>";
                }
             }
